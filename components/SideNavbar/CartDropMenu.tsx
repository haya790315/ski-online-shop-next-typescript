              ...
              <Link href="/product/[id]" as={`/product/${item._id}`} key={i}>
                <a href="">
                  <div
                    ...
                    key={i}
                  >
                  <div className="absolute top-0 left-0 text-white font-semibold bg-red-500 rounded-full h-6 w-6 flex justify-center items-center mt-2 z-10 ">{order && order.option[1]}</div>
